...
class SignUpViewModel: ObservableObject {
    ...
    func registerUser() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 2) { [weak self] in
            ...
            Theme.sessionManager.userProfile = .init(username: self.username, email: self.email, profilePictureURL: "https://media.licdn.com/dms/image/D4D03AQG5cquTJk65ug/profile-displayphoto-shrink_800_800/0/1701194433108?e=1727308800&v=beta&t=YPuai8-9sBbnVqqhTEYtWGeRu35luh8NmnzNoot-Vn8")
